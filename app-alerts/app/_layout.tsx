...
export default function Layout() {
  return (
    <Stack
      screenOptions={{
        headerStyle: { backgroundColor: "#2335bb" },
        headerTintColor: "#fff",
      }}
    >
      <Stack.Screen name="index" options={{ title: "Aplicativo de alertas" }} />
    </Stack>
  );
}
...
- O Stack organiza as telas em umja pilha, onde uma tela pode ser empilhada sobre a outra.
